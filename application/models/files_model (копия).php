...
//                                      ORDER BY files.files_id DESC");
    ...
    public function addFile($id = '')
    {
        ...
        $files_size_human = $this->data['vars']['files_size_human'];
        ...
        $this->db->insert('files', array(
                'files_client_id'      => $files_client_id,
                'files_description'    => $files_description,
                'files_events_id'      => $files_events_id,
                'files_extension'      => $files_extension,
                'files_foldername'     => $files_foldername,
                'files_name'           => $files_name,
                'files_show_name'      => $files_name,
                'files_project_id'     => $files_project_id,
                'files_uploaded_by'    => $files_uploaded_by,
                'files_uploaded_by_id' => $files_uploaded_by_id,
                'files_size'           => $files_size,
                'files_size_human'     => $files_size_human,
