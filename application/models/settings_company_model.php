...
class Settings_company_model extends Super_Model
{
    ...
    function editSettings()
    {
        ...
        //_____SQL QUERY_______
        $query = $this->db->query("UPDATE settings_company
                                          SET 
...
/* End of file settings_company_model.php */
/* Location: ./application/models/settings_company_model.php */
