 ...
 *
 * -------------------------------------------------------------
 * NEXTLOOP - MODIFIED 25 JULY 2014
 * Disabled XhR upload, so all uploads are via standard IFRAME
 *--------------------------------------------------------------
 */
...
/**---------------------------------------------------------------------------
 * NEXTLOOP: Modified to completely disable XHR uploads and revert only to IFRAME
 * [27 April 2014] Added: XhrOk = false;
 *---------------------------------------------------------------------------*/
  //XhrOk = false;
