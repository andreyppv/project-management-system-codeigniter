...
class BF_Model extends CI_Model
{
	...
	*/
     ...
     * @return mixed An object/array representing the db row, or FALSE.
     */
    public function find_one($return_type = 0)
    {
    ...
    public function find_one_fill_zero()
    {
        $row = $this->find_one(1);
    ...
    public function find_all_empty_array($return_type = 0)
    {
        $result = $this->find_all($return_type);
