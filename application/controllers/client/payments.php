...
class Payments extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        //template file
        $this->data['template_file'] = PATHS_CLIENT_THEME . 'payments.html';
    ...
    public function __viewPayments()
    {
        ...
        * (7)->offset
        ** -----------------------------------------*/
//echo $this->session->userdata('client_users_id');
        //profiling
        $this->data['controller_profiling'][] = __function__;
        ...
        $this->data['vars']['payments_amount_total'] = 0;
        foreach($this->data['blocks']['all_payments'] as $v)
        {
            $this->data['vars']['payments_amount_total'] += $v['payments_amount'];
        }
     ...
     */
    private function __cachedFormSearch()
    {
        ...
        redirect("client/payments/view/$search_id");
...
/* Location: ./application/controllers/client/payments.php */
