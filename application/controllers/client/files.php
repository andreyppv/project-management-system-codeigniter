    ...
    public function __filesAdd()
    {
        ...
        if ($next) {
            ...
            $file = array(
                ...
                'foldername'     => $files_foldername,
                'name'           => $files_name,
                'show_name'      => $files_name,
                'project_id'     => $files_project_id,
                'uploaded_by'    => $files_uploaded_by,
                'uploaded_by_id' => $files_uploaded_by_id,
                'size'           => $files_size,
                'size_human'     => convert_file_size($files_size)
            );
//print_r($file); exit;
            if ($result = $this->files_model->addFile($file)) {
                //show success
