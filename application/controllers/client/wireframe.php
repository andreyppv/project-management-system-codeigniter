...
class Wireframe extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        //template file
        $this->data['template_file'] = PATHS_CLIENT_THEME . 'project.wireframe.html';
    ...
    function __tasksView()
    {
        ...
        * -----------------------------------------*/
        ...
        $this->data['vars']['wireframeid'] = $project_id;
        ...
        if (isset($_POST['wireframe_title'], $_POST['wireframe_url'])){
            ...
            header("Location: http://pms.isodeveloper.com/client/wireframe_expanded/".$id);
            exit;
        }

        if (isset($_POST['wireframe_page'])){
            header("Location: http://pms.isodeveloper.com/client/wireframe_expanded/".intval($_POST['wireframe_page']));
            exit;
        }
