...
class People extends MY_Controller
{
     ...
     *
     */
    protected function __teamProfile()
    {
        ...
        if ($result) {
            ...
            $user_details['groups_name'] = $result['groups_name'];
            $user_details['last_active'] = $result['team_profile_last_active'];
     ...
     *
     */
    protected function __clientProfile()
    {
...
/* Location: ./application/controllers/admin/people.php */
