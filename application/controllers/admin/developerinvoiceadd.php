 ...
 */
class DeveloperInvoiceAdd extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        //template file
        $this->data['template_file'] = PATHS_ADMIN_THEME . 'developeraddinvoice.html';
    ...
    function getInvoice($id){
        ...
        $this->data['vars']['invoiceamount'] = round(($row['totalsecondsworked'] * (($row['rate']/60)/60)),2);
        ...
        //print_r($row['invoiceDetails']);
        //exit;

        foreach (json_decode($row['invoiceDetails'], true) as $details) {
