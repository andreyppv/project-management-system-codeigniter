...
class Tickets extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        //template file
        $this->data['template_file'] = PATHS_ADMIN_THEME . 'tickets.html';
    ...
    function __listTickets()
    {
        ...
        ** -----------------------------------------*/
		...
		{
        	$this->data['blocks']['tickets'] = $this->tickets_model->searchTickets($offset, 'search',$this->data['vars']['my_id']);
		}
		else {
    ...
    function __cachedFormSearch()
    {
        ...
        redirect("admin/tickets/view/search/$search_id");
    }
    ...
    function __flmFormValidation($form = '')
    {
        ...
        if ($form == 'add_ticket') {
            ...
            $fields = array(
                ...
                'tickets_client_id' => $this->data['lang']['lang_client'],
        ...
        //---------------validate form post data--------------------------
        if ($form == 'add_ticket_hidden') {

            //check required fields
            $fields = array('tickets_by_user_id' => $this->data['lang']['lang_user_id'], 'tickets_by_user_type' => $this->data['lang']['lang_type']);
            if (!$this->form_processor->validateFields($fields, 'required')) {
                return false;
            }
